  ...
  return (
    <section id="hero" className="row align-items-center mb-5">
      <div className="col-md-6">
        ...
        <div className="mt-4">
          <a className="btn btn-primary me-2" href="https://drive.google.com/file/d/1B7aoHc26ji7ZlA_ps5m1sCZhEm8iczw3/view?usp=sharing" target="_blank" rel="noreferrer">Download Resume</a>
